...
``MagicFormula61`` (rung 3, not yet implemented), one module per rung.
...
``M_z`` and the overturning/rolling moments are out of scope (an additive
upgrade that belongs to ``MagicFormula61``).
"""
